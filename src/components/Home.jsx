...
async function FetchMatchData() {
  ...
  try {
   ...
   // console.log(result);
   let filterData = result.matchDetails.filter(singleMatch => singleMatch["matchDetails"])
   ...
   <div className='flex flex-wrap w-full'>
    {
      matchesData.map(({matchDetailsMap : {match,key: date}},i)=>(
       ...
       match.map(({matchInfo: {team1 : {teamSName: team1Name,teamName : team1LongName ,imageId : team1Img},team2 :{teamSName:team2Name ,teamName : team2LongName,imageId : team2Img},status,matchId,matchDesc,state,matchFormat},matchScore}) =>(
        <Link to={`/matchDetail/${matchId}`} className='w-[50%] h-[150px]'>
        {/* <h1>{team1Name} vs {teamSName},
        {date} ,{status}
        </h1> */}
        <div className='bg-gray-700 border p-3 flex flex-col gap-4'>
            ...
            <div>
                <div className='flex justify-between'>
                    ...
                    <img className='w-4 object-contain' src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/${team1Img}`} alt=""></img>
                    <p>{team1Name}</p>
                    </div>
                ...
                <div className='flex justify-between'>
                    <div className='flex gap-6'>
                    <img className="w-4 object-contain"
                    src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/${team2Img}`} alt=''></img>
                    <p>{team2Name}</p>
                    </div>
